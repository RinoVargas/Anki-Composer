...
TEMPLATES = [
    TemplateDefinition(
        ...
        fields=[
            ...
            {"id": "meaning", "label": "Meaning", "audio_allowed": True}
        ],
        front_template="<div style='font-family: Arial; font-size: 26px; text-align: center; color: #4A90E2; font-weight: bold;'>{{EXPRESSION}}</div>",
        back_template="<div style='font-family: Arial; font-size: 20px; text-align: center; margin-bottom: 15px;'><b>Significado:</b> {{MEANING}}</div><hr id=answer><div style='font-size: 18px; color: #333; margin-top: 15px;'><i>Ejemplo:</i> {{MEANING}} {{$_MEANING}}</div>"
    )
]
