...
class DeckComposerTest(unittest.TestCase):
    ...
    def test_composer_specification_back_template_value(self):
        ...
        self.assertEqual(back_template.value,
    ...
    def test_composer_specification_front_template_value(self):
        ...
        self.assertEqual(front_template.value,
    ...
    def test_composer_specification_input_config_value(self):
        ...
        self.assertEqual(input_config.type, 'xlsx')
        self.assertEqual(input_config.file_path, '/my/specific/file.xlsx')
    ...
    def test_composer_specification_output_config_value(self):
        ...
        self.assertEqual(output_config.filename, 'my-package.dpkg')
        self.assertEqual(output_config.folder_path, '/my/output/folder')
